...
if (function_exists('acf_add_options_page')) {
  acf_add_options_page(array(
    'page_title' => 'Hakulomakkeen kentät',
    'menu_title' => 'Hakulomakkeen kentät',
    'menu_slug' => 'ar-application-form-fields',
  ));

  acf_add_options_page(array(
    'page_title' => 'Sivukenttien oletusarvot',
    'menu_title' => 'Sivukenttien oletusarvot',
    'menu_slug' => 'ar-options-fields',
  ));

  acf_add_options_page(array(
    'page_title' => 'Footerin kentät',
    'menu_title' => 'Footerin kentät',
    'menu_slug' => 'ar-footer-fields',
  ));
}
